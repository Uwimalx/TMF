...
直接运行下列命令即可（镜像使用 gitdl.cn）：
`sh -c "$(curl -fsSL https://github.com/Uwimalx/TMF/blob/main/init.sh)"`

镜像：
`sh -c "$(curl -fsSL https://gitdl.cn/https://github.com/Uwimalx/TMF/blob/main/init.sh)"`
